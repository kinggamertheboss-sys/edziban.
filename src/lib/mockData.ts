...
export interface MenuItem {
  ...
  category: 'mains' | 'sides' | 'snacks' | 'drinks' | 'condiments' | 'plates'
...
export const MENU_ITEMS: MenuItem[] = [
  ...
  // ── Individual Plates ──
  {
    ...
    unit: 'per plate',
    serves: '1 plate',
    description: 'Ghanaian jollof rice, two pieces of chicken, and your choice of shito or stew.',
    emoji: '🍛',
    video: '/videos/jollof.mp4',
    category: 'plates',
    options: ['Shito', 'Stew'],
  ...
  {
    id: 'jollof-plate-plantain',
    name: 'Fried Plantain',
    price: 2,
    unit: 'per plate add-on',
    serves: '1 add-on',
  ...
  {
    id: 'jollof-plate-salad',
    name: 'Ghana Salad',
    price: 2,
    unit: 'per plate add-on',
    serves: '1 add-on',
    description: 'Fresh Ghana salad with tomatoes, cucumbers, and light seasoning.',
    emoji: '🥗',
    category: 'plates',
    supplierId: 'supplier-1',
    supplierName: 'Auntie Naana Randolph',
  ...
  {
    id: 'jollof-plate-extra-sauce',
    name: 'Extra Shito or Stew',
    price: 1,
    unit: 'per plate add-on',
    serves: '1 add-on',
    description: 'Extra shito or stew on the side.',
    emoji: '🌶️',
    category: 'plates',
    supplierId: 'supplier-1',
    supplierName: 'Auntie Naana Randolph',
  ...
  {
    id: 'jollof-plate-extra-chicken',
    name: 'Extra Chicken',
    price: 4,
    unit: 'per plate add-on',
    serves: '1 add-on',
    description: 'One extra piece of chicken, marinated and cooked fresh.',
    emoji: '🍗',
    category: 'plates',
    supplierId: 'supplier-1',
    supplierName: 'Auntie Naana Randolph',
